...
const text = req.body.text; // body-parser is used to tap into req.body , we can do this thing using express also
...
//   const id = parseInt(req.params.id);
//   jokes.splice(id-1,1);
//   const check = jokes.find(joke => joke.id === id);
//   if(!check){
//     res.json("ok");
//   }
// });
